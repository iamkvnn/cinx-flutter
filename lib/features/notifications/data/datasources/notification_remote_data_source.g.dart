...
class _NotificationRemoteDataSource implements NotificationRemoteDataSource {
  ...
  @override
  Future<PaginatedApiResponse<List<UserNotificationResponse>>>
  getNotifications({int? page, int? size}) async {
    ...
    final _options =
        _setStreamType<PaginatedApiResponse<List<UserNotificationResponse>>>(
    ...
    late PaginatedApiResponse<List<UserNotificationResponse>> _value;
    try {
      _value = PaginatedApiResponse<List<UserNotificationResponse>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<UserNotificationResponse>(
                    (i) => UserNotificationResponse.fromJson(
  ...
  @override
  Future<ApiResponse<void>> toggleRead(String notificationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<void>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/notifications/${notificationId}/toggle-read',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
