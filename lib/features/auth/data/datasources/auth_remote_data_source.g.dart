...
class _AuthRemoteDataSource implements AuthRemoteDataSource {
  ...
  @override
  Future<ApiResponse<TokenResponseDto>> login(AuthRequestDto request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<ApiResponse<TokenResponseDto>>(
    ...
    late ApiResponse<TokenResponseDto> _value;
    try {
      _value = ApiResponse<TokenResponseDto>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<TokenResponseDto>> refreshToken(
  ...
  @override
  Future<ApiResponse<dynamic>> sendChangePasswordOtp(
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<ApiResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/auth/send-change-password-otp',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
