...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _CheckStatus value)?  checkStatus,TResult Function( _LoginRequested value)?  loginRequested,TResult Function( _LogoutRequested value)?  logoutRequested,TResult Function( _SendForgotPasswordOtp value)?  sendForgotPasswordOtp,TResult Function( _ResetPasswordRequested value)?  resetPasswordRequested,TResult Function( _UserUpdated value)?  userUpdated,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return resetPasswordRequested(_that);case _UserUpdated() when userUpdated != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _CheckStatus value)  checkStatus,required TResult Function( _LoginRequested value)  loginRequested,required TResult Function( _LogoutRequested value)  logoutRequested,required TResult Function( _SendForgotPasswordOtp value)  sendForgotPasswordOtp,required TResult Function( _ResetPasswordRequested value)  resetPasswordRequested,required TResult Function( _UserUpdated value)  userUpdated,}){
final _that = this;
switch (_that) {
case _CheckStatus():
...
return resetPasswordRequested(_that);case _UserUpdated():
return userUpdated(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _CheckStatus value)?  checkStatus,TResult? Function( _LoginRequested value)?  loginRequested,TResult? Function( _LogoutRequested value)?  logoutRequested,TResult? Function( _SendForgotPasswordOtp value)?  sendForgotPasswordOtp,TResult? Function( _ResetPasswordRequested value)?  resetPasswordRequested,TResult? Function( _UserUpdated value)?  userUpdated,}){
final _that = this;
switch (_that) {
case _CheckStatus() when checkStatus != null:
return checkStatus(_that);case _LoginRequested() when loginRequested != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  checkStatus,TResult Function( String email,  String password)?  loginRequested,TResult Function()?  logoutRequested,TResult Function( String email)?  sendForgotPasswordOtp,TResult Function( String email,  String otp,  String newPassword)?  resetPasswordRequested,TResult Function( UserDto user)?  userUpdated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckStatus() when checkStatus != null:
...
return resetPasswordRequested(_that.email,_that.otp,_that.newPassword);case _UserUpdated() when userUpdated != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  checkStatus,required TResult Function( String email,  String password)  loginRequested,required TResult Function()  logoutRequested,required TResult Function( String email)  sendForgotPasswordOtp,required TResult Function( String email,  String otp,  String newPassword)  resetPasswordRequested,required TResult Function( UserDto user)  userUpdated,}) {final _that = this;
switch (_that) {
case _CheckStatus():
...
return resetPasswordRequested(_that.email,_that.otp,_that.newPassword);case _UserUpdated():
return userUpdated(_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  checkStatus,TResult? Function( String email,  String password)?  loginRequested,TResult? Function()?  logoutRequested,TResult? Function( String email)?  sendForgotPasswordOtp,TResult? Function( String email,  String otp,  String newPassword)?  resetPasswordRequested,TResult? Function( UserDto user)?  userUpdated,}) {final _that = this;
switch (_that) {
case _CheckStatus() when checkStatus != null:
return checkStatus();case _LoginRequested() when loginRequested != null:
return loginRequested(_that.email,_that.password);case _LogoutRequested() when logoutRequested != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserUpdated&&const DeepCollectionEquality().equals(other.user, user));
}
